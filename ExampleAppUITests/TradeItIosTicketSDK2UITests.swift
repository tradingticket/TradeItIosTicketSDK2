...
class TradeItIosTicketSdk2UITests: XCTestCase {
    ...
    //* Helper methods *//
    //******************//
    fileprivate func testConfirmation(_ app: XCUIApplication){
    ...
    fileprivate func testPreviewValues(_ app: XCUIApplication, symbol: String, limitPrice: String, stopPrice: String, quantity: String){
    ...
    fileprivate func fillOrder(_ app: XCUIApplication, orderAction: String, orderType: String, limitPrice: String, stopPrice: String, share: String, expiration: String){
        //Shares
    ...
    fileprivate func testTradeScreenValues(_ app: XCUIApplication){
    ...
    fileprivate func symbolSearch(_ app: XCUIApplication, symbol: String){
    ...
    fileprivate func clearData(_ app: XCUIApplication) {
    ...
    fileprivate func handleWelcomeScreen(_ app: XCUIApplication, launchOption: String) {
    ...
    fileprivate func selectBrokerFromTheBrokerSelectionScreen(_ app: XCUIApplication, longBrokerName: String) {
    ...
    fileprivate func submitValidCredentialsOnTheLoginScreen(_ app: XCUIApplication, longBrokerName: String, username: String = "dummy", password: String = "dummy") {
    ...
    fileprivate func selectAccountOnPortfolioScreen(_ app: XCUIApplication, rowNum: Int) {
        waitForElementToAppear(app.navigationBars["Portfolio"])
    ...
    fileprivate func testPortfolioValues(_ app: XCUIApplication, brokerName: String){
        if(brokerName == "Dummy"){
            //AccountTotalValue
